...
- Когда гостевые ОС ничего не знают о том, что они виртуальные. Когда код гостевой виртуальной машины модифицирован и сама виртуалка знает о том, что она виртуальная машина. Этот подход позволят добиться большей производительности по сравнению с динамиеческой трансляцией. Апаратную виртуализацию требует KVM.
- Подходы к виртуализации: динамическая трансляция, паравиртуализация, апаратная виртуализация. КVM - решение для виртуализации встроенное в ядро Linux.

### «Получил по носу и решил «хватит». Как бросить «Интеграл» и начать своё дело в микроэлектронике
- Диана Васильева Sep 21 2017
- NTLab - дизайн микросхем (Дмитрий Черняковский - основатель компании)
- Развод с интегралом и зарождение новой компании
- От биометрического паспорта до зарождения медицинских имплантантов
- Сво IP блоки и импортозамещение
- Каждая ошибка обходится  в сотни тысяч долларов
- В 90-е было проще находить специалистов
- Будущее микроэлектроники по мнению интервьюированного в РБ

### Медитативная графика (Листы эмоций)
#### Keys:
- состоит, переживаний, возникают неволно, способствовать, исцелениею или болезни. Любое состояние, использовать для исцеления и самсовершенстования.
- Если, хорошее настроение, угасить плохое чувство, записанное на листе эмоций.
- сколько обид, столько листов. Число листов по одной, эмоции, люмым, в какой мере вы подвержены ей. МГ позволит нейтрализовать эмоции считанные часы!

#### Series words:
- Жизнь состоит из переживаний, которые возникают, как правило невольно. Эти события и ситуации могут способстовавать исцелению или болезни. Задача состоит в том, чтобы любое стостяние использвать для исцеления и самосовершенствования.
- Алгоритм следующий: если хорошее настроение - угашаем плохие переживания, если плохое переживание - создаем лист.
- Количество листов может быть любым, той эмоции, которой более подвержен, по той и больше листов. С помощью МГ можно нейтрализовать эмоцию за считанные часы.

#### Dominant:
- Задача состоит в том, чтобы любую жизненную ситуацию использовать для исцеления и самосоверженстования. МГ - инструмент. Создаются листы в момент переживания, используются листы во время противоположного переживания.

### Медитативная графика (Постижение смысле эмоции)
#### Keys:
- Рассамтривая прорамму эмоции, социальную функцию, в воспроизведении культуры. Она педупреждает, моглу быть хуже. Чаще всего эмоция бывает измбыточной. Избыток и устраняется в работе с листом МГ.
- Обострение чувств, продождении рисования будет угашение.
- Состоит из тех действий ума и их аффектво, эумоция проявляется и переживается.
- система умственных операций.
- элемент представляет в виде различающихся друг от друга обозначений.

#### Dominant
- Чаще всего эмоции бывают избыточной, избыток и устраняет МГ. Листы состоят из рисунков и слов, которы можно разделить на два элемента в виде различающихся друг от друа обозначений:
- умственные действия и их аффекты, в которых проявляется сама эта эмоция.
- система умственных операций.
...
4) PHP7
5) Маршрутизация
Система будет ознащеgiна способностью магического роутинга.
6) Пакеты и модули
